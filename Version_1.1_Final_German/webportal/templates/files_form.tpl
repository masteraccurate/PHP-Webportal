...
<tr><td colspan="2" align="center">
	<form name="ADD" action="index.php?id=files&amp;sid=post&amp;cid=>>CID<<" method="post">
	<label class="h2"><u>Dateieintragung</u></label>
</td></tr>
<tr><td>
...
<br>
<a href="index.php?id=files&cid=>>CID<<">Zur&uuml;ck zu den Datein</a>