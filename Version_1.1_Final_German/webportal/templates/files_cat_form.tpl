...
<tr><td colspan="2" align="center">
	<form name="ADD" action="index.php?id=files&amp;sid=postcat" method="post">
	<label class="h2"><u>Link-Kategorie eintragen</u></label>
</td></tr>
<tr><td>
...
<br>
<a href="index.php?id=files">Zur&uuml;ck zu den Datei-Kategorien</a>