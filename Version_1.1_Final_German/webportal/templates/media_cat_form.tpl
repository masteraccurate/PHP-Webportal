...
<tr><td colspan="2" align="center">
	<form name="ADD" action="index.php?id=media&amp;sid=postcat" method="post">
	<label class="h2"><u>Medien-Kategorie eintragen</u></label>
</td></tr>
<tr><td>
...
<br>
<a href="index.php?id=media">Zur&uuml;ck zu den Medien-Kategorien</a>