...
class main {
	function error($eid,$e_var) {
		if($eid == "1") {
			$error = "<font color=\"#FF0000\" face=\"Arial\">Template Fehler: Datei ".$e_var." nicht gefunden!</font><br>\n";
		} elseif($eid == "2") {
			$error = "<font color=\"#FF0000\" face=\"Arial\">Modul Fehler: Datei ".$e_var." nicht gefunden!</font><br>\n";
		} elseif($eid == "3") {
			$error = "<font color=\"#FF0000\" face=\"Arial\">MySQL-DB Fehler: Nicht verbunden zu MySQL-Server mit String: ".$e_var."</font><br>\n";
		} else {
			$error = "<font color=\"#FF0000\" face=\"Arial\">Kernel Fehler: Variable eid or e_var in Error-Funktion nicht festgelegt!</font><br>\n";
		}
		return $error;
	}
	function includes() {
