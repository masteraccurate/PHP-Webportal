...
<tr><td colspan="2" align="center">
	<form name="ADD" action="index.php?id=media&amp;sid=post&amp;cid=>>CID<<" method="post">
	<label class="h2"><u>Medieneintragung</u></label>
</td></tr>
<tr><td>
...
<br>
<a href="index.php?id=media&cid=>>CID<<">Zur&uuml;ck zu den Medien</a>