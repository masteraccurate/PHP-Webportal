	...
	function main() {
		if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == "1") {
			...
			$content = "Willkommen auf meiner Seite die sich derzeit noch im Bau befindet.<br>".
				...
				"<b>Jetzt ist endlich auch das Board online! Viel Spaß damit.<br>Herunterladen kannst du das PHP-Webportal bei Sourceforge.net unter: <a href=\"https://sourceforge.net/projects/php-webportal/\" target=\"_BLANK\">Download</a></b>";
		}
		return $content;
	}
}
