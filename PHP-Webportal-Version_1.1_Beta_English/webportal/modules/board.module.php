...
class board {
	...
	function main() {
		...
		if(isset($_GET['cid']) && ($_GET['cid'] != "") && empty($_GET['sid']) && empty($_GET['scid'])) {
			...
			$link = "<a href=\"index.php?id=board&amp;sid=board_subcat_form&cid=".htmlspecialchars($_GET['cid'])."\">Post Forum</a><br>\n<br><hr>\n";
			$render = str_replace("\n","",$content);
			...
			$link = "<a href=\"index.php?id=board&amp;sid=board_form&cid=".htmlspecialchars($_GET['cid'])."&scid=".htmlspecialchars($_GET['scid'])."\">Post Comment</a><br>\n<br><hr>\n";
			...
			$content = $render."Seite: ".$sites."<br><br><a href=\"index.php?id=board&amp;cid=".$_GET['cid']."\">Back to Forums</a>";
			mysqli_free_result($result);
			mysqli_close($connect);
			...
			if(isset($result)) {
				$link = "<a href=\"index.php?id=board&amp;cid=".htmlspecialchars($_GET['cid'])."\">Go to Board-Category</a><br>\n<br>\n";
			...
			$result = mysqli_query($connect,$statement);
			if(isset($result)) {
				$link = "<a href=\"index.php?id=board&amp;cid=".htmlspecialchars($_GET['cid'])."&amp;scid=".htmlspecialchars($_GET['scid'])."\">Back to Forum</a><br>\n<br>\n";
