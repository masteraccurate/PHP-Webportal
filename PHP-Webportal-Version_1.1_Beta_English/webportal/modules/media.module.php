...
class media {
	...
	function main() {
		...
		if(isset($_GET['cid']) && ($_GET['cid'] != "") && empty($_GET['sid'])) {
			...
			$link = "<a href=\"index.php?id=media&amp;sid=media_form&cid=".htmlspecialchars($_GET['cid'])."\">Post Media</a><br>\n<br><hr>\n";
			$render = str_replace("\n","",$content);
			...
			if(isset($result)) {
				$link = "<a href=\"index.php?id=media&amp;cid=".htmlspecialchars($_GET['cid'])."\">Go to Media-Category</a><br>\n<br>\n";
