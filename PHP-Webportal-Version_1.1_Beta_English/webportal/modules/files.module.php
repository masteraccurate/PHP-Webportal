...
class files {
	...
	function main() {
		...
		if(isset($_GET['cid']) && ($_GET['cid'] != "") && empty($_GET['sid'])) {
			...
			$link = "<a href=\"index.php?id=files&amp;sid=files_form&cid=".htmlspecialchars($_GET['cid'])."\">Post file</a><br>\n<br><hr>\n";
			$render = str_replace("\n","",$content);
			...
			if(isset($result)) {
				$link = "<a href=\"index.php?id=files&amp;cid=".htmlspecialchars($_GET['cid'])."\">Back to kategories</a><br>\n<br>\n";
