...
class images {
	...
	function main() {
		...
		if(isset($_GET['cid']) && ($_GET['cid'] != "") && empty($_GET['sid'])) {
			...
			$link = "<a href=\"index.php?id=images&amp;sid=images_form&cid=".htmlspecialchars($_GET['cid'])."\">Post Image</a><br>\n<br><hr>\n";
			$render = str_replace("\n","",$content);
			...
			if(isset($result)) {
				$link = "<a href=\"index.php?id=images&amp;cid=".htmlspecialchars($_GET['cid'])."\">Go to Image-Category</a><br>\n<br>\n";
