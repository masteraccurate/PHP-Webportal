...
class links {
	...
	function main() {
		...
		if(isset($_GET['cid']) && ($_GET['cid'] != "") && empty($_GET['sid'])) {
			...
			$link = "<a href=\"index.php?id=links&amp;sid=links_form&cid=".htmlspecialchars($_GET['cid'])."\">Post Link</a><br>\n<br><hr>\n";
			$render = str_replace("\n","",$content);
			...
			if(isset($result)) {
				$link = "<a href=\"index.php?id=links&amp;cid=".htmlspecialchars($_GET['cid'])."\">Go to Link-Category</a><br>\n<br>\n";
